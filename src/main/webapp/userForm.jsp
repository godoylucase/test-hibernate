...
<tr>
    <th><label for="robot"><fmt:message key="user.robot"/>:</label></th>
		<td><form:select id="robot" path="robot" cssClass="form-control">
				<form:option value="">Robot ..</form:option>
				<form:options items="${robotMap}" />
				<form:errors path="robot" cssClass="fieldError" />
			</form:select></td>
		</tr>
<tr>
